...
const uint8_t F_TETRIS = 1;
const uint8_t W_TETRIS = 9;
static const uint8_t PROGMEM tetris[F_TETRIS * W_TETRIS] =
{
  0x70, 0x50, 0x70, 0x7e, 0x5a, 0x7e, 0x70, 0x50, 0x70
};

const uint8_t F_INVADER1 = 6;
const uint8_t W_INVADER1 = 8;
static const uint8_t PROGMEM invader1[F_INVADER1 * W_INVADER1] =
{
  0x98, 0x5c, 0xf6, 0x7f, 0x7f, 0xf6, 0x5c, 0x98,
  0x98, 0x5c, 0xf6, 0x7f, 0x7f, 0xf6, 0x5c, 0x98,
  0x98, 0x5c, 0xf6, 0x7f, 0x7f, 0xf6, 0x5c, 0x98,
  0x98, 0x5c, 0xfe, 0x7f, 0x7f, 0xfe, 0x5c, 0x98,
  0x98, 0x5c, 0xfe, 0x7f, 0x7f, 0xfe, 0x5c, 0x98,
  0x98, 0x5c, 0xfe, 0x7f, 0x7f, 0xfe, 0x5c, 0x98
};

const uint8_t F_FRIENDS = 10;
const uint8_t W_FRIENDS = 15;
static const uint8_t PROGMEM friends[F_FRIENDS * W_FRIENDS] =
{
  0x78, 0xf4, 0xdc, 0xdc, 0xf4, 0x78, 0x00, 0x7c, 0x82, 0x89, 0xa1, 0xa1, 0x85, 0x82, 0x7c,
  0x78, 0xf4, 0xdc, 0xdc, 0xf4, 0x78, 0x00, 0x7c, 0x82, 0x89, 0xa1, 0xa1, 0x85, 0x82, 0x7c,
  0x78, 0xf4, 0xdc, 0xdc, 0xf4, 0x78, 0x00, 0x7c, 0x82, 0x89, 0xa1, 0xa1, 0x85, 0x82, 0x7c,
  0x78, 0xf4, 0xdc, 0xdc, 0xf4, 0x78, 0x00, 0x7c, 0x82, 0x89, 0xa1, 0xa1, 0x85, 0x82, 0x7c,
  0x78, 0xf4, 0xdc, 0xdc, 0xf4, 0x78, 0x00, 0x7c, 0x82, 0x89, 0xa1, 0xa1, 0x85, 0x82, 0x7c,
      ...
      case 1: // Temperature
        ...
        switch (anim)
        {
          ...
          case 3:
            ...
            break;
          case 4:
            P.setSpriteData(tetris, W_TETRIS, F_TETRIS, invader1, W_INVADER1, F_INVADER1);
            anim++;
            break;
          case 5:
            P.setSpriteData(invader1, W_INVADER1, F_INVADER1, friends, W_FRIENDS, F_FRIENDS);
            anim++;
            break;
          case 6:
            P.setSpriteData(friends, W_FRIENDS, F_FRIENDS, pacman1, W_PMAN1, F_PMAN1);
            anim = 0;
            break;
        }
